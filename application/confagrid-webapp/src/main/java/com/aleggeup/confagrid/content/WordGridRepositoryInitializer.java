...
public class WordGridRepositoryInitializer {
    ...
    private final UserRepositoryInitializer userRepositoryInitializer;

    @Autowired
    public WordGridRepositoryInitializer(final WordGridRepository wordGridRepository,
        final UserRepository userRepository,
        final UserRepositoryInitializer userRepositoryInitializer) {
        this.wordGridRepository = wordGridRepository;
        this.userRepository = userRepository;
        this.userRepositoryInitializer = userRepositoryInitializer;
    }
